...
<!---Motifs -->
We analysed the three-species motif that are most frequent in food-webs and that have a clear ecological interpretation [@McCann1998; @Baiser2016]. Only four motifs are presented in the networks analysed here: apparent competition, exploitative competition, tri-trophic chain and omnivory (Figure 1). We compared the frequency of these motif to Erdös-Rényi (E–R) random graph with the same number of nodes $n$ and edges $m$. We performed 1000 simulations of E-R random networks and calculated the z-score of motif frequencies using the equation:  
