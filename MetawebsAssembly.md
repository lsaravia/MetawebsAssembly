...
In recent years there has been an increased interest in spatial and temporal variation in food web structure. This is a necessary step to understand the influences of climate change and other global threats like biological invasions to ecosystems. The pool of species present in a broad area and its potential interactions have been called metaweb, in analogy with the metacommunity concept. Local food webs are realizations of metawebs that are the result of assembly processes influenced by migration, habitat filtering, stochastic factors, and dynamical constraints imposed by food web structure. In this work we analyze the biggest metaweb available up to now: the marine Antarctic metaweb. And compare it with to more local food webs that represent two different spatial scales: the Weddell sea and Potter Cove, a small fjord. One way to represent the processes that shape food webs is to use subgraphs of nodes called motifs, we use three node motifs that represent a tri-trophic chain, omnivory, apparent competition and exploitative competition. Due to the different spatial scales, the motif representation of the Weddel sea should be more similar to the metaweb than the motifs of Potter Cove. Another important property that characterizes food webs is the existence of subsets of species that interact more frequently among themselves than with other
species: compartmentalization. As the metaweb do not represent realized interactions we expect that the local webs will be more compartmentalized. We will also analyze the general topological characteristic of the food webs, and compare all the results to disentangle which processes are more important to shape food webs at different spatial scales.
