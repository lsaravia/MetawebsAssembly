...
<!-- I replaced old paragraphs by NPK versions -->
...
In the cases that the extension and the size of the metaweb are much higher than the local food webs---as the Antarctic metaweb---the changes in the structure of the modules and the habitats are more important, probably producing the observed differences. 

<!-- NPK: I don't know what this paragraph is saying LAS: I added a phrase at the end of the previous paragraph 
