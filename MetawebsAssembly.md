...
Besides we can not rule out the possibility of the ghost of stability in the past, as this would probably require the inclusion of evolutionary processes in the model and the design of new computational experiments, recent experimental studies have detected that biotic interactions were present but weak or transient and that community structure depends more strongly on regional environmental factors [@Hacker2019], this is in line with our results that showed differences of topological roles with seemingly different local habitas and almost no influence of stability constraints on local food web structure. 
