...
topoRoles <- calc_topological_roles(redl,mod_by_red[[1]])

plot_topological_roles(topoRoles,redl,mod_by_red[[1]])
...
topoRoles <- calc_topological_roles(redl,mod_by_red[[2]])

plot_topological_roles(topoRoles,redl,mod_by_red[[2]])
