...
#   ggplot( aes(x=fct_reorder(Net_name,Metaweb),y=Q,color=Metaweb)) + geom_point(size=2) +scale_color_brewer(palette = "Paired")+ 
...
#   ggplot( aes(x=fct_reorder(Net_name,Metaweb),y=Modularity,color=Metaweb)) + geom_point(size=2) +scale_color_brewer(palette = "Paired")+ 
