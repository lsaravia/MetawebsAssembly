...
# There are no differences we can use 500 time steps
...
* The idea is to calculate a bivariate confidence ellipse and check if the desired object is inside it 
