...
----------------------------------------------------
Table: Small-world-ness, coherence (Q), mean trophic level and modularity, with 99% confidence intervals based on 1000 random networks.
...
SWness 99%CI        2.53       1.14
    ...
    Q high        1.1485   0.8035   

**Mean trophic    2.1289   1.9831   
  Level** 

  T.L. low        1.5911   1.7635   

  T.L. high       2.5568   2.0977   

 **Modularity**   0.3720   0.4784   

   MO low         0.2670   0.3768   

   MO high        0.6142   0.5299   
------------------------------------
Table: Small-world-ness, coherence (Q), mean trophic level and modularity with 99% confidence intervals based on 1000 networks generated by the meta-web assembly model.
...
Modularity           -0.98       1.03  
assembly 
z-score
--------------------------------------

Table: Z-scores calculated against 1000 simulated networks using the metaweb assembly model. Quantities marked with '*' are significant at 1% level. A negative z-score means that the quantity is smaller than the expectation from null model simulations; a positive z-score means that is greater.
