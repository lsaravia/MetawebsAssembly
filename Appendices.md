...
---------------- -------- --------- 
    ...
    Q high        1.0575   0.8035   

**Mean trophic    2.1289   1.9831   
  Level** 

  T.L. low        1.5896   1.7384   

  T.L. high       2.5600   2.0987   

 **Modularity**   0.3720   0.4784   

   MO low         0.2691   0.3657   

   MO high        0.6306   0.5366   
------------------------------------
Table: Modularity, number of groups coherence (q) and mean trophic level with 99% confidence intervals based on 1000 networks generated by the meta-web assembly model.
